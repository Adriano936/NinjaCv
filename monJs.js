...
$('.imgScroll').mouseout(function(){
	$('.imgScroll').attr('src','images/logoScroll.png');
});
// ---- Hover  Logo Scroll responsiv ancre1 ----
$('.imgScroll2').mouseover(function(){
	$('.imgScroll2').attr('src','images/logoScrollhover.png');
});
$('.imgScroll2').mouseout(function(){
	$('.imgScroll2').attr('src','images/logoScroll.png');
});
// ---- Hover  Logo Cv ----
$('.imgLogoCv, .imgLogoCvyl').mouseover(function(){
	$('.imgLogoCv, .imgLogoCvyl').attr('src','images/logoCvHover.png');
});
$('.imgLogoCv, .imgLogoCvyl').mouseout(function(){
	$('.imgLogoCv, .imgLogoCvyl').attr('src','images/logoCv.png');
});
// ---- Hover  Joue Cv ----
$('.imgLogoJoue , .imgLogoJoueyl').mouseover(function(){
	$('.imgLogoJoue , .imgLogoJoueyl').attr('src','images/logoJoueHover.png');
});
$('.imgLogoJoue , .imgLogoJoueyl').mouseout(function(){
	$('.imgLogoJoue , .imgLogoJoueyl').attr('src','images/logoJoue.png');
});
// ---- Hover  instruction ----
$('.imgLogoInstructions').mouseover(function(){
	$('.imgLogoInstructions').attr('src','images/logo-instructions-hover.png');
});
$('.imgLogoInstructions').mouseout(function(){
	$('.imgLogoInstructions').attr('src','images/logo-instructions.png');
});
// ---- clic instructions ----
...
$( "#maTete" ).hover(function() {
	$( this ).fadeTo( 0, 1, function(){
		$('#maTete').attr("src","images/photoProfilhover.png");
	});
});
